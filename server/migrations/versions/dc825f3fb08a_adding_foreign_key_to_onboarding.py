"""adding foreign key to onboarding

Revision ID: dc825f3fb08a
Revises: 
Create Date: 2024-04-02 15:17:04.444266
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['emp_id'], ['employees.id'], name=op.f('fk_onboardings_emp_id_employees')),
    sa.PrimaryKeyConstraint('id')
    )
